...
public class GraphAdjMatrix extends Graph {
	...
	public List<Integer> getDistance2(int v) {
		...
		ArrayList<Integer> distance2 = new ArrayList<Integer>();
		 ArrayList<Integer> oneStep = (ArrayList<Integer>) getNeighbors(v);
		 for(Integer o : oneStep){
			 ArrayList<Integer> oneout = (ArrayList<Integer>) getNeighbors(o.intValue());
			 distance2.addAll(oneout);
		 }
