...
//           }
	...
	public static void main(String[] args)
	{
		...
		GraphLoader.createIntersectionsFile("data/maps/UCIrvine.map", 
					                         "data/intersections/UCIrvine.intersections");
		GraphLoader.createIntersectionsFile("data/maps/HUST.map", 
                "data/intersections/HUST.intersections");
		GraphLoader.createIntersectionsFile("data/maps/USC.map", 
                "data/intersections/USC.intersections");
		GraphLoader.createIntersectionsFile("data/maps/SEU.map", 
                "data/intersections/SEU.intersections");
